...
const HowItWorksSection: React.FC = () => {
  return (
    <div className="py-16 px-4 md:px-8 bg-gradient-to-b from-white/80 to-[var(--mint-50)]/80 backdrop-blur-sm">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((step) => (
              <div key={step} className="bg-white/70 backdrop-blur-sm p-6 rounded-xl shadow-sm border border-[var(--mint-100)]">
