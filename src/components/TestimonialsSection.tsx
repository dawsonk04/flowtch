...
const TestimonialsSection: React.FC = () => {
  ...
  return (
    <div className="py-10 px-4 md:px-8 bg-gradient-to-b from-transparent to-[var(--mint-50)]/50">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-8 text-gray-800">What Our Clients Say</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-white p-8 rounded-xl shadow-md relative border border-gray-200">
